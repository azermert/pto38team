...
#define  TIM_CR1_UDIS                        ((uint16_t)0x0002)            /*!<Update disable (log1 = UEV disabled)*/
#define  TIM_CR1_URS                         ((uint16_t)0x0004)            /*!<Update request source (log1 = Only counter overflow and DMa generates an update interrupt)*/
#define  TIM_CR1_OPM                         ((uint16_t)0x0008)            /*!<One pulse mode */
#define  TIM_CR1_DIR                         ((uint16_t)0x0010)            /*!<Direction (1 = Downcounter)*/
...
#define  TIM_CCMR2_OC3M_Toggle               ((uint16_t)0x0030)            
#define  TIM_CCMR2_OC3M_PWM1				 ((uint16_t)0x0060)
...
#define  TIM_CCMR2_OC4M_Toggle               ((uint16_t)0x3000)      

                    ...
                    case XmlNodeType.Text:
                        switch (param_name) { 
                            ...
                            case "connect":
                                ...
                                break;
                            case "gen_maxf":
                                procConf.genMaxf = int.Parse(reader.Value);
                                break;
                            case "gen_depth":
                                procConf.genDept = int.Parse(reader.Value);
                                break;
                            case "gen_buffsize":
                                procConf.genBuffLenght = int.Parse(reader.Value);
                                break;
                            case "gen_pin":
                                procConf.genPin = reader.Value;
                                break;
                            case "gen_v_ref":
                                procConf.genVref_mv = int.Parse(reader.Value);
                                break;
                            default:
                                break;
                        }                       
